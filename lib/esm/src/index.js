...
class DiffViewer extends React.Component {
    ...
    renderDiff = () => {
        ...
        const { lineInformation, diffLines } = computeLineInformation(oldValue, newValue, disableWordDiff, compareMethod, linesOffset, this.props.alwaysShowLines, lineDiffMethod);
